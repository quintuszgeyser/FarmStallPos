...
function Start-App {
    ...
    $global:AppProcess = Start-Process powershell -ArgumentList "-ExecutionPolicy Bypass -WindowStyle Hidden -File `"$StartScript`"" -WorkingDirectory $ScriptDir -WindowStyle Hidden -PassThru
